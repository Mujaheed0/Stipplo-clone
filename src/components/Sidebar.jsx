import { WechatOutlined, FileTextOutlined, MenuOutlined } from "@ant-design/icons";
import React from "react";

function Sidebar({show,setShowSideBar}) {
  return (
    <div className={`md:relative md:top-0 md:left-64 w-64 ${show?'translate-x-0 z-30':'-translate-x-full'} transition-transform ease-in-out  fixed top-0 bg-slate-600  text-white h-full  flex flex-shrink-0 flex-col p-4`}>
      <div className=""></div>
      ...
      <div className="links_container mt-10 ">
        ...
        <div className="flex flex-col gap-3 justify-items-center list-none">
          <li className=" flex items-center gap-5  hover:bg-gray-400 w-full py-2 rounded-md font-bold hover:font-bold px-3 bg-blue-300 ">
